"""Tests for the Memory Management protocol agent."""

from unittest.mock import patch

import pytest

from agents.protocol.memory_management import get_memory_management_agent


class TestMemoryManagementAgentFactory:
    """Agent factory returns an Agent with the expected configuration."""

    @patch("agents.protocol.memory_management.get_fireworks_llm")
    @patch("agents.protocol.memory_management.Agent")
    def test_factory_returns_agent(self, MockAgent, mock_llm):
        """get_memory_management_agent should create an Agent instance."""
        instance = MockAgent.return_value
        result = get_memory_management_agent()
