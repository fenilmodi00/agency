"""Tests for the Entity Registry protocol agent."""

from unittest.mock import patch

import pytest

from agents.protocol.entity_registry import get_entity_registry_agent


class TestEntityRegistryAgentFactory:
    """Agent factory returns an Agent with the expected configuration."""

    @patch("agents.protocol.entity_registry.get_fireworks_llm")
    @patch("agents.protocol.entity_registry.Agent")
    def test_factory_returns_agent(self, MockAgent, mock_llm):
        """get_entity_registry_agent should create an Agent instance."""
        instance = MockAgent.return_value
        result = get_entity_registry_agent()
